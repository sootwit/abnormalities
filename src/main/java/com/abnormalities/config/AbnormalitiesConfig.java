...
public class AbnormalitiesConfig {
    ...
    public static final ForgeConfigSpec.BooleanValue XYZ_ONLY_VANILLA;
    ...
    public static final ForgeConfigSpec.IntValue PEAK_DAY_BAD_XYZ_MULT;
    public static final ForgeConfigSpec.IntValue PEAK_DAY_GOOD_XYZ_MULT;
    ...
    static {
        ...
        K3W_SPAWN_WEIGHT = b.comment("higher = rarer spawns").defineInRange("spawnWeight", 5000, 1, 1000000);
        ...
        XYZ_SPAWN_WEIGHT = b.comment("higher = rarer xyz spawns").defineInRange("spawnWeight", 4000, 1, 100000);
        ...
        VR9P_SPAWN_WEIGHT = b.comment("higher = rarer natural spawns").defineInRange("spawnWeight", 4000, 1, 100000);
        ...
        VR9P_STARGAZED_SPAWN_WEIGHT = b.comment("higher = rarer stargazed events").defineInRange("spawnWeight", 12000, 1, 100000);
        ...
        PEAK_DAY_BAD_XYZ_MULT = b.comment("xYz item count multiplier on BAD days").defineInRange("badXyzMult", 2, 1, 10);
        PEAK_DAY_GOOD_XYZ_MULT = b.comment("xYz item count multiplier on GOOD days").defineInRange("goodXyzMult", 1, 1, 10);
